...
import { Hammer, type LucideIcon, ShoppingBasket, UtensilsCrossed } from 'lucide-react-native';
    ...
    <View pointerEvents="box-none" style={[styles.host, { paddingBottom: Math.max(insets.bottom, Spacing.md) }]}>
      ...
      >
        {state.routes.map((route, index) => {
          ...
          const Icon = ICONS[route.name] ?? ShoppingBasket;
