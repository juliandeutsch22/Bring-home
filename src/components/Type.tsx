// Type.tsx — Typo-Hierarchie (Style Guide A4/A5).
//
// Zwei Stimmen: Display-Schrift für Überschriften, System-Font für Text.
// Zahlen, die sich ändern: tabular-nums. Farben kommen aus useColors() — nie
// graue Hex hardcoden.
